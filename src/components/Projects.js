...
import websiteImg6 from '../assets/FeedbackApp.jpg';
    ...
    const config = {
        projects: [
            ...
            },
            {
                ...
                link: 'https://github.com/PREDEEP464/Feedback-System'
            }     
        ]
    }

    return (
        <section id="projects" className="relative flex flex-col py-20 px-5 justify-center bg-gradient-to-r from-red-600 via-purple-700 to-orange-500 text-white">
            {/* Overlay div for dark background */}
            <div className="absolute inset-0 bg-black opacity-20"></div>

            <div className="w-full">
                <div className="flex flex-col px-10 py-5 justify-center items-center relative z-10">
